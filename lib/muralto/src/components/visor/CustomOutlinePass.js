...
class CustomOutlinePass extends Pass {
  constructor(resolution, scene, camera) {
    ...
    // Add clipping planes support to the normal material
    this.normalOverrideMaterial = new THREE.MeshNormalMaterial({
      clippingPlanes: [],
      clipShadows: true,
    });

    // This will be populated with active clipping planes
    this.clippingPlanes = [];
  }
  ...
  render(renderer, writeBuffer, readBuffer) {
    // Store original clipping state
    const originalLocalClipping = renderer.localClippingEnabled;

    // Enable local clipping planes
    renderer.localClippingEnabled = true;

    // Update clipping planes in normal material
    this.normalOverrideMaterial.clippingPlanes = this.clippingPlanes;
    ...
    renderer.localClippingEnabled = originalLocalClipping;
  }
